...
public class ConnectionPool {
    ...
    public static final String ERROR_CONNECTION_DATA = "Error connection to the data source.";
    public static final String ATTEMPT_TO_CLOSE_CLOSED_CON = "Attempting to close closed connection.";
    public static final String ERROR_DELETING_CONNECTION = "Error deleting connection from the given away connection pool.";
    public static final String ERROR_ALLOCATING_CONNECTION_IN_POOL = " Error allocating connection in the pool.";
    ...
    public Connection takeConnection() throws ConnectionPoolException {
        ...
        try {
            ...
            throw new ConnectionPoolException(ERROR_CONNECTION_DATA, e);
        }
        return connection;
    }
    ...
    private class PooledConnection implements Connection {
        ...
        public void close() throws SQLException {
            ...
            if (!giveAwayConQueue.remove(this)) {
                throw new SQLException(ERROR_DELETING_CONNECTION);
            }
            if (!connectionQueue.offer(this)) {
                throw new SQLException(ERROR_ALLOCATING_CONNECTION_IN_POOL);
            }
        }
